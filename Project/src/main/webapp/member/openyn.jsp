...
<body>
        ...
        <section id="settingTab">
          ...
          <div class="settingTop">
            ...
            <a class="settingBt" href="./settingPW.html">
              <img src="./icon/key.png" class="imgSize">
              <span>비밀번호 변경</span>
            </a>
            </div>
          <div class="settingBottom">
            ...
            <a class="settingBt" href="./setting3.html">
              <img src="./icon/block.png" class="imgSize">
              <span>차단된 계정</span>
            </a>
          </div>
        </section>
  ...
  <main>
    ...
    <div class="inner2 clearfix">
      ...
      <div id="settingTop">
        <span>비공개 계정</span>
        <input type='checkbox' id='toggle2' class='tgl' onchange="sendData(this)";/>
  ...
  <script>
	...
	$.ajax({
		url : "/Dongstagram/accounts/acouunt/openyn",
			type : "post",
			data : {account:acouuntValue, openyn:value},
