...
//@WebServlet("/")
@WebServlet(urlPatterns = { "/page/*", "/direct/*", "/user/*", "/accounts/*", "/data/*", "/reply/*", "/favorite/*", "/explore" }) // 가상경로만 여기에 넣기. 실제 경로는 이
